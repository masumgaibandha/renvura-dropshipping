...
export function MobileFilterDrawer({ children }: MobileFilterDrawerProps) {
  ...
  return (
    <Drawer.Root state={state}>
      <Drawer.Trigger className="inline-flex h-10 items-center gap-1.5 rounded-full border border-border bg-surface px-4 text-small font-medium text-foreground transition-colors hover:border-accent hover:text-accent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus">
